...
#### Preview
---
![Landing Page Preview](https://github.com/cpa-landing-pages/crossy-road-hack/blob/master/preview.png)

#### Download
---
[<img src="http://svgshare.com/i/28_.svg" width="40%" alt="Download" />](https://github.com/cpa-landing-pages/crossy-road-hack/archive/master.zip)
...
> Step 5 (optional)
- To change CSS, open `css/default.min.css` and beautify the file. You can Google for "CSS Beautify" or you can use the one that we mentioned for any file type. Make sure to minify the file after you're done, for faster page load.
